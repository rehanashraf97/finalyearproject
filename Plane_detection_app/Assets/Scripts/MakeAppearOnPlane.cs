    ...
    */
    ...
    void Update()
    {
        ...
        if (m_RaycastManager.Raycast(touch.position, s_Hits, TrackableType.PlaneWithinPolygon))
        {
            ...
            Vector3 tem_pos = new Vector3(hitPose.position.x, hitPose.position.y, hitPose.position.z);
            ...
            m_SessionOrigin.MakeContentAppearAt(content.transform, hitPose.position, Quaternion.identity);
        }
    }
